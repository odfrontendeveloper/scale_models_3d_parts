...
<ul>
    ...
    <li>Якщо репозиторій некоректно відображає файл, чи выдображає його пустим, завантажте його і вікдрийте у програмі, яка підтримує відповідний формат (наприклад: Windows 3D Builder)</li>
</ul>
